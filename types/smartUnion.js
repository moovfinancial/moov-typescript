...
const discriminatedUnion_js_1 = require("./discriminatedUnion.js");
...
function countFieldsRecursive(parsed) {
    ...
    while (index < queue.length) {
        ...
        if (value === undefined || (0, discriminatedUnion_js_1.isUnknown)(value)) {
            continue;
        }
        ...
        if (value === null
            ...
            || value instanceof decimal_js_1.Decimal) {
            fieldCount++;
            continue;
        }
        // Handle arrays
