...
function string() {
    return z.union([
        ...
        z.any().transform((x) => (0, unrecognized_js_1.unrecognized)(JSON.stringify(x))),
    ]);
}
function boolean() {
    return z.union([
...
function optional(t) {
    return z.union([
        z.undefined(),
        // Null -> undefined
        z.null().transform(() => (0, unrecognized_js_1.unrecognized)(undefined)),
        t,
    ]);
}
function nullable(t) {
    return z.union([
        z.null(),
        // Undefined -> null
        z.undefined().transform(() => (0, defaultToZeroValue_js_1.defaultToZeroValue)(null)),
        t,
    ]);
}
function zodDefaultToZeroValue(value) {
    return z.any().transform((input, ctx) => {
        if (input === undefined)
            return (0, defaultToZeroValue_js_1.defaultToZeroValue)(value);
        if (input === null)
            return (0, defaultToZeroValue_js_1.defaultToZeroValue)(value);
        ctx.addIssue({
            code: "invalid_type",
