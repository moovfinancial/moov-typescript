...
```typescript
const value: components.GooglePayTransferPaymentMethod = {
...
```typescript
const value: components.PushToGooglePayTransferPaymentMethod = {
...
```typescript
const value: components.PullFromGooglePayTransferPaymentMethod = {
