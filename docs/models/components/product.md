...
| `category`                                                                                                                                         | [components.ProductCategory](../../models/components/productcategory.md)                                                                           | :heavy_minus_sign:                                                                                                                                 | The product taxonomy category associated with the product, if any.                                                                                 |
