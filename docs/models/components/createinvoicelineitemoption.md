...
```typescript
import { CreateInvoiceLineItemOption } from "@moovio/sdk/models/components";

let value: CreateInvoiceLineItemOption = {
  name: "<value>",
  quantity: 842013,
  priceModifier: {
    currency: "USD",
...
| `images`                                                                                         | [components.CreateInvoiceLineItemImage](../../models/components/createinvoicelineitemimage.md)[] | :heavy_minus_sign:                                                                               | Optional list of images associated with this line item option.                                   |