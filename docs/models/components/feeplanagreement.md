...
let value: FeePlanAgreement = {
  ...
  planID: "<id>",
  name: "<value>",
  acceptedOn: new Date("2026-03-16T07:09:49.539Z"),
  status: "active",
...
| `priorAgreementID`                                                                                                                                                                                     | *string*                                                                                                                                                                                               | :heavy_minus_sign:                                                                                                                                                                                     | The agreement this one replaced. Only set when the agreement was created by replacing another.                                                                                                         |
| `priorAgreementTerminatedOn`                                                                                                                                                                           | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                                                                                                          | :heavy_minus_sign:                                                                                                                                                                                     | The date and time the prior agreement was terminated.                                                                                                                                                  |