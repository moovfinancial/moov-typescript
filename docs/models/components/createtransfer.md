...
| `feePaidBy`                                                                                                                             | [components.TransferFeePaidBy](../../models/components/transferfeepaidby.md)                                                            | :heavy_minus_sign:                                                                                                                      | Indicates which party bears fees for a transfer, keyed by fee type.                                                                     |                                                                                                                                         |