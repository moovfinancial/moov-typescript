...
```typescript
import { PullFromCardTransferPaymentMethod } from "@moovio/sdk/models/components";

let value: PullFromCardTransferPaymentMethod = {
...
| `paymentMethodType`                                                                            | *"pull-from-card"*                                                                             | :heavy_check_mark:                                                                             | N/A                                                                                            |
