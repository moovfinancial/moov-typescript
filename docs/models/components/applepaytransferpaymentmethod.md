...
```typescript
import { ApplePayTransferPaymentMethod } from "@moovio/sdk/models/components";

let value: ApplePayTransferPaymentMethod = {
...
| `paymentMethodType`                                                        | *"apple-pay"*                                                              | :heavy_check_mark:                                                         | N/A                                                                        |
