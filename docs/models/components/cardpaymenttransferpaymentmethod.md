...
```typescript
import { CardPaymentTransferPaymentMethod } from "@moovio/sdk/models/components";

let value: CardPaymentTransferPaymentMethod = {
...
| `paymentMethodType`                                                                            | *"card-payment"*                                                                               | :heavy_check_mark:                                                                             | N/A                                                                                            |
