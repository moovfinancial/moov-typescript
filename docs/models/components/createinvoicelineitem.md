...
| `images`                                                                                                                                                                   | [components.CreateInvoiceLineItemImage](../../models/components/createinvoicelineitemimage.md)[]                                                                           | :heavy_minus_sign:                                                                                                                                                         | Optional list of images associated with this line item.                                                                                                                    |