...
```typescript
import { CreateScheduledTransferLineItem } from "@moovio/sdk/models/components";

let value: CreateScheduledTransferLineItem = {
  name: "<value>",
  basePrice: {
    currency: "USD",
...
| `options`                                                                                                              | [components.CreateScheduledTransferLineItemOption](../../models/components/createscheduledtransferlineitemoption.md)[] | :heavy_minus_sign:                                                                                                     | Optional list of modifiers applied to this item (e.g., toppings, upgrades, customizations).                            |
