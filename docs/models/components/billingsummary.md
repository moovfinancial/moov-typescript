...
| ~~`adjustmentFees`~~                                                                                                                                                                                                                                       | [components.BillingSummaryAdjustmentFees](../../models/components/billingsummaryadjustmentfees.md)                                                                                                                                                         | :heavy_minus_sign:                                                                                                                                                                                                                                         | : warning: ** DEPRECATED **: This will be removed in a future release, please migrate away from it as soon as possible.<br/><br/>The total amount of adjustment fees. This field is deprecated and will be removed in a future release. Use adjustments.total. |
...
| `totalNetPartnerPayment`                                                                                                                                                                                                                                   | [components.AmountDecimal](../../models/components/amountdecimal.md)                                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                                                                                                         | Final partner payment after deducting monthlyPartnerCosts and any adjustments.                                                                                                                                                                             |