...
let value: GetScheduledOccurrenceResponse = {
  ...
  result: {
    ...
    occurrences: {
      mode: "production",
      runOn: new Date("2025-09-25T04:48:13.660Z"),
      runTransfer: {
        amount: {
          currency: "USD",
          value: 1204,
        ...
        description: "red black furthermore as below",
      },
    },
    ...
    createdOn: new Date("2025-07-25T16:42:32.993Z"),
    updatedOn: new Date("2024-04-03T09:10:36.479Z"),
  },
};
```
