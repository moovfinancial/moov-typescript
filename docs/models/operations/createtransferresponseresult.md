...
const value: components.TransferResponse = {
  transferID: "e0f63fde-8b88-4fb9-a621-4b321d336a9e",
  createdOn: new Date("2024-09-07T22:05:58.754Z"),
};
```
...
const value: components.AsyncTransfer = {
  transferID: "bac9ceb5-4aa0-4b30-a2a8-d1da3bb14a6c",
  createdOn: new Date("2025-07-28T06:27:03.803Z"),
};
```
