...
```typescript
import { BatchGetTransfersResponse } from "@moovio/sdk/models/operations";

let value: BatchGetTransfersResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
...
| `result`                                                                   | Record<string, [components.Transfer](../../models/components/transfer.md)> | :heavy_check_mark:                                                         | N/A                                                                        |