...
async function run() {
  const result = await moov.industries.listIndustries({
    basicAuth: {
      username: "",
      password: "",
    },
...
import { industriesListIndustries } from "@moovio/sdk/funcs/industriesListIndustries.js";
...
async function run() {
  const res = await industriesListIndustries(moov, {
    basicAuth: {
      username: "",
      password: "",
    },
...
**Promise\<[components.EnrichedIndustry[]](../../models/.md)\>**
