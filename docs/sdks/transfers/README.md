...
<!-- UsageSnippet language="typescript" operationID="batchGetTransfers" method="post" path="/accounts/{accountID}/transfers/.fetch" -->
```typescript
import { Moov } from "@moovio/sdk";
...
async function run() {
  const result = await moov.transfers.batchGetTransfers({
    accountID: "<id>",
...
```typescript
import { MoovCore } from "@moovio/sdk/core.js";
import { transfersBatchGetTransfers } from "@moovio/sdk/funcs/transfersBatchGetTransfers.js";
...
async function run() {
  const res = await transfersBatchGetTransfers(moov, {
    accountID: "<id>",
    batchGetTransfersRequest: {
      transferIDs: [
        "<value 1>",
  ...
  if (res.ok) {
    ...
    console.log("transfersBatchGetTransfers failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.BatchGetTransfersRequest](../../models/operations/batchgettransfersrequest.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.BatchGetTransfersResponse](../../models/operations/batchgettransfersresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getTransfer" method="get" path="/accounts/{accountID}/transfers/{transferID}" example="Awaiting capture card payment transfer" -->
```typescript
import { Moov } from "@moovio/sdk";
...
<!-- UsageSnippet language="typescript" operationID="listCancellations" method="get" path="/accounts/{accountID}/transfers/{transferID}/cancellations" example="Cancellations" -->
```typescript
import { Moov } from "@moovio/sdk";
...
async function run() {
  const result = await moov.transfers.listCancellations({
    accountID: "<id>",
    transferID: "<id>",
  });
...
```typescript
import { MoovCore } from "@moovio/sdk/core.js";
import { transfersListCancellations } from "@moovio/sdk/funcs/transfersListCancellations.js";
...
async function run() {
  const res = await transfersListCancellations(moov, {
    accountID: "<id>",
    transferID: "<id>",
  });
  if (res.ok) {
    ...
    console.log("transfersListCancellations failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.ListCancellationsRequest](../../models/operations/listcancellationsrequest.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.ListCancellationsResponse](../../models/operations/listcancellationsresponse.md)\>**
