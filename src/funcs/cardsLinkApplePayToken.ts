 ...
 */
export async function cardsLinkApplePayToken(
  client: MoovCore,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.LinkedApplePayPaymentMethod$inboundSchema),
    M.jsonErr([400, 409], errors.GenericError$inboundSchema),
    M.fail([401, 403, 404, 429, "4XX"]),
    M.jsonErr(422, errors.LinkApplePayError$inboundSchema),
    M.fail([500, 504, "5XX"]),
