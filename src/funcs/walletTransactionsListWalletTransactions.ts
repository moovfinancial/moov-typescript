 ...
 */
export async function walletTransactionsListWalletTransactions(
  client: MoovCore,
  ...
  Result<
    Array<components.WalletTransaction>,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListWalletTransactionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.WalletTransaction$inboundSchema)),
