...
> {
  ...
  const pathParams = {
    ...
    paymentMethodID: encodeSimple("paymentMethodID", payload.paymentMethodID, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPaymentMethodResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
