 ...
 * scope.
 */
export async function transfersPatchTransfer(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchTransferRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/accounts/{accountID}/transfers/{transferID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.Transfer$inboundSchema),
