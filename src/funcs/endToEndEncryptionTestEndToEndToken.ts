 ...
 */
export async function endToEndEncryptionTestEndToEndToken(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TestEndToEndTokenRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.E2EEToken, { explode: true });

  const path = pathToFunc("/debug/end-to-end-token")();
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "429", "4XX", "500", "504", "5XX"],
