 ...
 */
export function issuingTransactionsGetAuthorization(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIssuedCardAuthorizationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetIssuedCardAuthorizationResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
