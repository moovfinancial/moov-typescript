 ...
 */
export function bankAccountsGetVerification(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBankAccountVerificationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBankAccountVerificationResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
