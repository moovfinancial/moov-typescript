...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListTicketMessagesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/accounts/{accountID}/tickets/{ticketID}/messages")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListTicketMessagesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([401, 403, 429]),
