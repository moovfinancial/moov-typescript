 ...
 */
export async function adjustmentsListAdjustments(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAdjustmentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/accounts/{accountID}/adjustments")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.Adjustment$inboundSchema)),
