 ...
 */
export function brandingCreate(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateBrandRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateBrandResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
