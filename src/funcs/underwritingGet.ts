 ...
 */
export function underwritingGet(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetUnderwritingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUnderwritingResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
