 ...
 */
export async function capabilitiesAddCapabilities(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddCapabilitiesRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(422, errors.AddCapabilitiesError$inboundSchema),
    M.fail([500, 504, "5XX"]),
