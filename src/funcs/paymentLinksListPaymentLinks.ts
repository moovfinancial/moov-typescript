 ...
 */
export async function paymentLinksListPaymentLinks(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPaymentLinksRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.PaymentLink$inboundSchema)),
