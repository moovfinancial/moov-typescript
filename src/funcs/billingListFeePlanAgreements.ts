 ...
 */
export async function billingListFeePlanAgreements(
  client: MoovCore,
  ...
  Result<
    Array<components.FeePlanAgreement>,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListFeePlanAgreementsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.FeePlanAgreement$inboundSchema)),
