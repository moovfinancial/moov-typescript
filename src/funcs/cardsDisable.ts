 ...
 */
export function cardsDisable(
  client: MoovCore,
  request: operations.DisableCardRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DisableCardResponse | undefined,
    | errors.GenericError
    | MoovError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DisableCardRequest$outboundSchema.parse(value),
