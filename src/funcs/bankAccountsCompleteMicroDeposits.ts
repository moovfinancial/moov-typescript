 ...
 */
export function bankAccountsCompleteMicroDeposits(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CompleteMicroDepositsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CompleteMicroDeposits, {
    explode: true,
  });
