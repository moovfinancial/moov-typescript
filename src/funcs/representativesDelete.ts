 ...
 */
export function representativesDelete(
  client: MoovCore,
  request: operations.DeleteRepresentativeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteRepresentativeResponse | undefined,
    | errors.GenericError
    | MoovError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteRepresentativeRequest$outboundSchema.parse(value),
