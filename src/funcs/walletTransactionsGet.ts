 ...
 */
export function walletTransactionsGet(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWalletTransactionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetWalletTransactionResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
