 ...
 */
export async function sweepsListSweepConfigs(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSweepConfigsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.SweepConfig$inboundSchema)),
