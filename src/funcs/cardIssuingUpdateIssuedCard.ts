 ...
 */
export async function cardIssuingUpdateIssuedCard(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateIssuedCardRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateIssuedCard, { explode: true });
  ...
  >(
    ...
    M.jsonErr(422, errors.UpdateIssuedCardError$inboundSchema),
    M.fail([500, 504, "5XX"]),
