...
export enum GetPaymentLinkQRCodeAcceptEnum {
 ...
 */
export async function paymentLinksGetPaymentLinkQRCode(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPaymentLinkQRCodeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetPaymentLinkQRCodeResponse$inboundSchema),
    M.stream(200, operations.GetPaymentLinkQRCodeResponse$inboundSchema, {
      ctype: "image/png",
    }),
