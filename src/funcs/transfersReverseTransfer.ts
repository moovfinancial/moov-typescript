 ...
 */
export async function transfersReverseTransfer(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ReverseTransferRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json([200, 202], components.Reversal$inboundSchema),
