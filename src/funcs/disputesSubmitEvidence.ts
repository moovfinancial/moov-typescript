 ...
 */
export async function disputesSubmitEvidence(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubmitDisputeEvidenceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.SubmitDisputeEvidenceResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
