 ...
 */
export function sweepsUpdateConfig(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateSweepConfigRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateSweepConfigResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr([400, 409], errors.GenericError$inboundSchema, { hdrs: true }),
    M.jsonErr(422, errors.PatchSweepConfigError$inboundSchema, { hdrs: true }),
