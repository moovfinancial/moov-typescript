 ...
 */
export async function representativesCreate(
  client: MoovCore,
  ...
  Result<
    ...
    | errors.GenericError
    | errors.RepresentativeValidationError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateRepresentativeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateRepresentativeResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr([400, 409], errors.GenericError$inboundSchema, { hdrs: true }),
    M.jsonErr(422, errors.RepresentativeValidationError$inboundSchema, {
      hdrs: true,
    }),
