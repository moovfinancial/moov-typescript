 ...
 */
export async function cardIssuingListIssuedCards(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListIssuedCardsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.IssuedCard$inboundSchema)),
