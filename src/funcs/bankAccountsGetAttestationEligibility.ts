 ...
 */
export function bankAccountsGetAttestationEligibility(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBankAccountAttestationEligibilityRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "getBankAccountAttestationEligibility",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.GetBankAccountAttestationEligibilityResponse$inboundSchema,
