 ...
 */
export async function paymentLinksCreatePaymentLink(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreatePaymentLinkRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreatePaymentLink, { explode: true });
  ...
  >(
    ...
    M.jsonErr(422, errors.CreatePaymentLinkError$inboundSchema),
    M.fail([500, 504, "5XX"]),
