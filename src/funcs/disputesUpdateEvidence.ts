 ...
 */
export function disputesUpdateEvidence(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateDisputeEvidenceRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateEvidence, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateDisputeEvidenceResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
