...
export enum GetDisputeEvidenceDataAcceptEnum {
 ...
 */
export async function disputesGetDisputeEvidenceData(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDisputeEvidenceDataRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.stream(200, operations.GetDisputeEvidenceDataResponse$inboundSchema, {
