 ...
 */
export async function onboardingListInvites(
  client: MoovCore,
  _request: operations.ListOnboardingInvitesRequest,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListOnboardingInvitesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([401, 403, 429]),
