 ...
 */
export function applePayUpdateMerchantDomains(
  client: MoovCore,
  request: operations.UpdateApplePayMerchantDomainsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApplePayMerchantDomainsResponse | undefined,
    | errors.GenericError
    | MoovError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateApplePayMerchantDomainsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.UpdateApplePayMerchantDomains, {
    explode: true,
  });
  ...
  >(
    ...
    M.fail([401, 403, 404, 409, 417, 429]),
    M.fail([500, 504]),
    M.fail("4XX"),
    M.fail("5XX"),
