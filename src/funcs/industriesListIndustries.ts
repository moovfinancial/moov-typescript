 ...
 */
export async function industriesListIndustries(
  client: MoovCore,
  ...
  Result<
    Array<components.EnrichedIndustry>,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListIndustriesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.EnrichedIndustry$inboundSchema)),
