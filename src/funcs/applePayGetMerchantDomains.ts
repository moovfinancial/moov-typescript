 ...
 */
export function applePayGetMerchantDomains(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApplePayMerchantDomainsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApplePayMerchantDomainsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
