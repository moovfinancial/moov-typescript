 ...
 */
export async function disputesListDisputeEvidence(
  client: MoovCore,
  ...
  Result<
    Array<components.DisputeEvidenceMetadata>,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListDisputeEvidenceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.DisputeEvidenceMetadata$inboundSchema)),
