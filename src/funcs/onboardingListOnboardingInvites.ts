 ...
 */
export async function onboardingListOnboardingInvites(
  client: MoovCore,
  ...
  Result<
    Array<components.OnboardingInvite>,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListOnboardingInvitesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.OnboardingInvite$inboundSchema)),
