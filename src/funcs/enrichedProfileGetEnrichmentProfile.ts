 ...
 */
export async function enrichedProfileGetEnrichmentProfile(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetEnrichmentProfileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/enrichment/profile")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.EnrichedBusinessProfile$inboundSchema),
