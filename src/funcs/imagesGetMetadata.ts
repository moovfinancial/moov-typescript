 ...
 */
export function imagesGetMetadata(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetImageMetadataRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetImageMetadataResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
