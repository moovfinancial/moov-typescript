...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateCardRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateCard, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateCardResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr([400, 409], errors.GenericError$inboundSchema, { hdrs: true }),
    M.jsonErr(422, errors.UpdateCardError$inboundSchema, { hdrs: true }),
