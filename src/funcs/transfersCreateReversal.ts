 ...
 */
export function transfersCreateReversal(
  client: MoovCore,
  ...
  Result<
    ...
    | errors.GenericError
    | errors.ReversalValidationError
    | MoovError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateReversalRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([200, 202], operations.CreateReversalResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr([400, 409], errors.GenericError$inboundSchema, { hdrs: true }),
    M.jsonErr(422, errors.ReversalValidationError$inboundSchema, {
      hdrs: true,
    }),
