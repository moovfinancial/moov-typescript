 ...
 */
export function transfersGetCapture(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCaptureRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    captureID: encodeSimple("captureID", payload.captureID, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCaptureResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
