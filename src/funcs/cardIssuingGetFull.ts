 ...
 */
export async function cardIssuingGetFull(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFullIssuedCardRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetFullIssuedCardResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
