 ...
 */
export async function institutionsListInstitutions(
  client: MoovCore,
  ...
  Result<
    Array<components.FinancialInstitutions>,
    | errors.GenericError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListInstitutionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/institutions/ach/search")();
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "403", "429", "4XX", "500", "504", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.FinancialInstitutions$inboundSchema)),
