 ...
 */
export function schedulingGetOccurrance(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetScheduledOccurrenceRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    occurrenceFilter: encodeSimple(
      "occurrenceFilter",
      payload.occurrenceFilter,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScheduledOccurrenceResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
