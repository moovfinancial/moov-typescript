 ...
 */
export async function issuingTransactionsListIssuedCardAuthorizationEvents(
  client: MoovCore,
  ...
  Result<
    Array<components.IssuedCardAuthorizationEvent>,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListIssuedCardAuthorizationEventsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.IssuedCardAuthorizationEvent$inboundSchema)),
