 ...
 */
export async function disputesListDisputes(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListDisputesRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    "cardholderAccountID": payload.cardholderAccountID,
    "count": payload.count,
    "disputeIDs": payload.disputeIDs,
    "endDateTime": payload.endDateTime,
    "merchantAccountID": payload.merchantAccountID,
    "orderBy": payload.orderBy,
    "respondEndDateTime": payload.respondEndDateTime,
    "respondStartDateTime": payload.respondStartDateTime,
    "skip": payload.skip,
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.Dispute$inboundSchema)),
