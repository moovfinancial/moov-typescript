 ...
 */
export async function disputesDeleteDisputeEvidenceFile(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteDisputeEvidenceFileRequest$outboundSchema.parse(value),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "403", "404", "409", "429", "4XX", "500", "504", "5XX"],
  ...
  >(
    ...
    M.jsonErr(409, errors.GenericError$inboundSchema),
    M.fail([500, 504, "5XX"]),
