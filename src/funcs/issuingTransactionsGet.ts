 ...
 */
export function issuingTransactionsGet(
  client: MoovCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIssuedCardTransactionRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    cardTransactionID: encodeSimple(
      "cardTransactionID",
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetIssuedCardTransactionResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
