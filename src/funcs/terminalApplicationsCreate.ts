...
> {
  const parsed = safeParse(
    request,
    (value) => components.CreateTerminalApplication$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateTerminalApplicationResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
