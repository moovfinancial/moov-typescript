...
func (p PingGlobals) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *PingGlobals) UnmarshalJSON(data []byte) error {
...
func (o *PingGlobals) GetXMoovVersion() *string {
	if o == nil {
		return nil
	}
...
func (o *PingRequest) GetXMoovVersion() *string {
	if o == nil {
		return nil
	}
	return o.XMoovVersion
...
func (o *PingResponse) GetHeaders() map[string][]string {
	if o == nil {
