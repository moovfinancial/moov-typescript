...
const (
	...
	RequirementIDBusinessBusinessType                      RequirementID = "business.business-type"
	...
	RequirementIDBusinessVolumeByCustomerType              RequirementID = "business.volume-by-customer-type"
	RequirementIDBusinessCardVolumeDistribution            RequirementID = "business.card-volume-distribution"
	RequirementIDBusinessFulfillment                       RequirementID = "business.fulfillment"
	...
	RequirementIDDocumentBusinessVerification              RequirementID = "document.business.verification"
	RequirementIDDocumentIndividualTin                     RequirementID = "document.individual.tin"
	RequirementIDDocumentIndividualVerification            RequirementID = "document.individual.verification"
	RequirementIDDocumentRepresentativeRepUUIDTin          RequirementID = "document.representative.{rep-uuid}.tin"
	RequirementIDDocumentRepresentativeRepUUIDVerification RequirementID = "document.representative.{rep-uuid}.verification"
...
func (e *RequirementID) UnmarshalJSON(data []byte) error {
	...
	case "business.average-monthly-transaction-volume":
		fallthrough
	case "business.volume-by-customer-type":
		fallthrough
	case "business.card-volume-distribution":
		fallthrough
	case "business.fulfillment":
		fallthrough
	...
	case "bank-accounts.account-number":
		fallthrough
	case "document.business.verification":
		fallthrough
	case "document.individual.tin":
		fallthrough
	case "document.individual.verification":
		fallthrough
	case "document.representative.{rep-uuid}.tin":
		fallthrough
	case "document.representative.{rep-uuid}.verification":
		fallthrough
