...
> = z.object({
  ...
  taxIDProvided: types.optional(types.boolean()),
  representatives: types.optional(z.array(Representative$inboundSchema)),
  ownersProvided: types.boolean(),
